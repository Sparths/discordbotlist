          ...
          <TabsContent value="profile" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>This information is imported from your Discord account.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="grid gap-4">
                  <div className="grid gap-2">
                    ...
                    <Input id="display-name" placeholder="Enter a custom display name" />
                    <p className="text-sm text-muted-foreground">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Your email will be visible to other users.</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Your bots will be displayed on your public profile.</p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">When someone reviews your bots</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">News, updates, and promotions</p>
                    </div>
                    <Switch id="marketing" />
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <h3 className="text-sm font-medium">Discord Authentication</h3>
                  <p className="text-sm text-muted-foreground">
                    Your account is linked to Discord. You can only sign in using Discord.
                  </p>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between p-2 rounded-md bg-muted">
                      <div className="text-sm">
                        ...
                        <div className="text-xs text-muted-foreground">Chrome on Windows • Active now</div>
                      </div>
                      <Badge variant="outline" className="bg-green-100 text-green-800 border-green-300">
                        Current
                      </Badge>
